...
#define END_ADDRESS			(uint32_t)0x0801EFFF    /* End address of application space (addr. of last byte) */
#define BL_CRC_ADDRESS		(uint32_t)0x0801F000    /* Start address of application checksum in flash */
#define APP_CRC_ADDRESS		(uint32_t)0x0801F004    /* Start address of application checksum in flash */
#define APP_LENGTH_ADDRESS	(uint32_t)0x0801F008    /* Start address of application checksum in flash */
...
#define RAM_SIZE			(uint32_t)0x00005000	// 20 kB
